        ...
        public void OnMouseDown(MouseEventArgs e)
        {
            if (Main != null && Layout == null)
            {
                ...
                else if (e.Button == MouseButtons.Left)
                {
                    ...
                    //if (Rectangle.Contains(scaledPoint))
                    //{
                    //    //MessageBox.Show($"{Rectangle.Location}");
                    //    if (Main.Itemplacement)
                    //    {
                    ...
                    //            if (totalitemyuksekligi + Main.item_yuksekligi <= CellYuksekligi)
                    //            {
                    //                Item item = new Item(0, 0, Main.item_eni, Main.item_boyu, Zoomlevel, Main);
                    //                item.Rectangle = resizeandPosition(Main.item_eni, Main.item_boyu, CellEni, CellBoyu, OriginalRectangle);
                    //                item.OriginalRectangle = item.Rectangle;
                    //                item.ItemEtiketi = Main.item_etiketi;
                    //                item.ItemYuksekligi = Main.item_yuksekligi;
                    //                item.ItemTuru = "Balya";
                    //                item.ItemBoyu = Main.item_boyu;
                    //                item.ItemEni = Main.item_eni;
                    //                item.KareX = item.Rectangle.X;
                    //                item.KareY = item.Rectangle.Y;
                    //                item.KareEni = item.Rectangle.Width;
                    //                item.KareBoyu = item.Rectangle.Height;
                    //                item.OriginalKareX = item.OriginalRectangle.X;
                    //                item.OriginalKareY = item.OriginalRectangle.Y;
                    //                item.OriginalKareEni = item.OriginalRectangle.Width;
                    //                item.OriginalKareBoyu = item.OriginalRectangle.Height;
                    //                item.LocationofRect = new Point((int)item.Rectangle.X, (int)item.Rectangle.Y);
                    //                item.ItemAgirligi = Main.item_agirligi;
                    //                item.Zoomlevel = Zoomlevel;
                    //                item.CellId = CellId;
                    //                item.ApplyZoom(Zoomlevel);

                    //                item.Rectangle = new RectangleF(
                    //                    (int)(Rectangle.X + (Rectangle.Width / 2 - item.Rectangle.Width / 2)),
                    //                    (int)(Rectangle.Y + (Rectangle.Height / 2 - item.Rectangle.Height / 2)),
                    //                    (int)(item.Rectangle.Width), (int)(item.Rectangle.Height));

                    //                item.LocationofRect = new Point((int)item.Rectangle.X, (int)item.Rectangle.Y);

                    //                var item1 = (from x in context.Items
                    //                             where x.ItemEtiketi == item.ItemEtiketi
                    //                             select x).FirstOrDefault();

                    //                if (item.ItemEni > CellEni)
                    //                {
                    //                    MessageBox.Show
                    //                        ("Balyanın eni, hücrenin eninden daha büyük lütfen tekrar deneyiniz.",
                    //                        "Balyanın boyutu büyük", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //                    Main.Itemplacement = false;
                    //                    Itemplacement = false;
                    //                    itemremoval = false;
                    //                }
                    //                else if (item.ItemBoyu > CellBoyu)
                    //                {
                    //                    MessageBox.Show
                    //                        ("Balyanın boyu, hücrenin boyundan daha büyük lütfen bir daha deneyiniz.",
                    //                        "Balyanın boyutu büyük", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //                    Main.Itemplacement = false;
                    //                    Itemplacement = false;
                    //                    itemremoval = false;
                    ...
                    //                    if (item1 != null)
                    //                    {
                    //                        MessageBox.Show("Bu etiketli bir balya zaten bulunuyor, Lütfen başka bir etiket girin", "Etiket zaten var", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //                        Main.Itemplacement = false;
                    //                        Itemplacement = false;
                    //                        itemremoval = false;
                    //                    }
                    ...
                    //                        Main.Move = true;
                    //                        ItemSayisi++;
                    //                        MainPanelMakeSmaller(Main.DrawingPanel);
                    //                        Main.Show_BalyaYerlestirmePaneli();
                    //                        Main.DrawingPanel.Invalidate();
                    //                    }
                    //                }
                    //            }
                    //            else
                    //            {
                    //                MessageBox.Show("Balyaların yüksekliği hücrenin yüksekliğinden fazla",
                    //                    "Hücrede yer kalmadı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    //                Main.Itemplacement = false;
                    //                Itemplacement = false;
                    //                itemremoval = false;
                    //            }
                    ...
                    //                context.SaveChanges();
                    //                Main.DrawingPanel.Invalidate();
                    //                Main.itemremoval = false;
                    //                Itemplacement = false;
                    //                ItemplacementContextMenuStripButton = false;
                    //                itemremoval = false;
                    //            }
                    //        }
                    //    }
